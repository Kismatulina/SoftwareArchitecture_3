...
//пример OCP.(Open/Closed Principle, принцип открытости/закрытости)
...
//если добавить фигуру, то все переписывать
...
//Principle OCP
        ...
        double sumAreaV2 = 0; //ниже перебираю элементы на уровне контракта, который предоставляет моя абстракция.ShapeV2 - это минимальный контракт
